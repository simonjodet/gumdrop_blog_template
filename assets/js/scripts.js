jQuery(function ($) {
  ...
  if ($('#pagination_btn').length == 1) {
    ...
    var drawNewPage = function (page) {
      ...
      clone.children('div.page-header').children('h3').children('a')[0].setAttribute('href', page.location);
      clone.children('div.page-header').children('h3').children('a')[0].innerHTML = page.title;
      var subtitle = clone.children('div.page-header').children('h3').children('small')[0].innerHTML;
      subtitle = subtitle.replace("__page.date__", page.date);
      clone.children('div.page-header').children('h3').children('small')[0].innerHTML = subtitle;
      clone.children('div.post-content')[0].innerHTML = page.content;
